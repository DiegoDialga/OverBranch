...
const CertificationInfoForm = ({certifications, addArrayItem, removeArrayItem, updateArrayItem}) => {
    return (
        <>
                            ...
                            <div key={index} className={"border border-gray-200/80 p-4 rounded-lg relative"}>
...

                                {
                                    certifications.length > 1 && (
                                        <button
                                            type={"button"}
                                            className={"absolute top-3 right-3 text-red-500 hover:underline cursor-pointer"}
